  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(225, 225, 225, 1);borderRadius:26px">
        <h1 class="h1" style="color:rgba(244, 91, 75, 1);fontSize:28px;">汽车站车辆运管系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yuangong'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.longitude" class="input" type="text" placeholder="经度">
			   </div>
			 </div> -->
			<el-form-item label="经度" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.longitude" autocomplete="off" placeholder="经度"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuangong'" class="input-group">
			   <div class="label">纬度</div>
			   <div class="input-container">
			     <input v-model="ruleForm.latitude" class="input" type="text" placeholder="纬度">
			   </div>
			 </div> -->
			<el-form-item label="纬度" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.latitude" autocomplete="off" placeholder="纬度"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuangong'" class="input-group">
			   <div class="label">地址</div>
			   <div class="input-container">
			     <input v-model="ruleForm.fulladdress" class="input" type="text" placeholder="地址">
			   </div>
			 </div> -->
			<el-form-item label="地址" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.fulladdress" autocomplete="off" placeholder="地址"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if(`yuangong` == this.tableName && this.ruleForm.longitude&&(!this.$validate.isNumber(this.ruleForm.longitude))){
        this.$message.error(`经度应输入数字`);
        return
      }
      if(`yuangong` == this.tableName && this.ruleForm.latitude&&(!this.$validate.isNumber(this.ruleForm.latitude))){
        this.$message.error(`纬度应输入数字`);
        return
      }
      this.$http({
