    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="业务详情" prop="yewuxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yewuxiangqing" label="业务详情" prop="yewuxiangqing">
                    <span v-html="ruleForm.yewuxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.yewuxiangqing = this.ruleForm.yewuxiangqing.replace(reg,'../../../ssm8ji1j/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yewuguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yewuguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
