<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="路线" prop="luxian">
          <el-input v-model="ruleForm.luxian" 
              placeholder="路线" clearable  :readonly="ro.luxian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="路线" prop="luxian">
              <el-input v-model="ruleForm.luxian" 
                placeholder="路线" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车票类型" prop="chepiaoleixing">
          <el-input v-model="ruleForm.chepiaoleixing" 
              placeholder="车票类型" clearable  :readonly="ro.chepiaoleixing"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="管理员工号" prop="guanliyuangonghao">
          <el-select  @change="guanliyuangonghaoChange" v-model="ruleForm.guanliyuangonghao" placeholder="请选择管理员工号">
            <el-option
                v-for="(item,index) in guanliyuangonghaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.guanliyuangonghao" label="管理员工号" prop="guanliyuangonghao">
              <el-input v-model="ruleForm.guanliyuangonghao" 
                placeholder="管理员工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车票售价" prop="chepiaoshoujia">
          <el-input v-model="ruleForm.chepiaoshoujia" 
              placeholder="车票售价" clearable  :readonly="ro.chepiaoshoujia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车票售价" prop="chepiaoshoujia">
              <el-input v-model="ruleForm.chepiaoshoujia" 
                placeholder="车票售价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车票数量" prop="chepiaoshuliang">
          <el-input v-model="ruleForm.chepiaoshuliang" 
              placeholder="车票数量" clearable  :readonly="ro.chepiaoshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车票数量" prop="chepiaoshuliang">
              <el-input v-model="ruleForm.chepiaoshuliang" 
                placeholder="车票数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	guanliyuangonghao : false,
	guanliyuanxingming : false,
	chepiaoshoujia : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chepiaoleixing = true;
          ...
          if(o=='guanliyuangonghao'){
            this.ruleForm.guanliyuangonghao = obj[o];
	    this.ro.guanliyuangonghao = true;
            continue;
          }
	    ...
	    this.ro.guanliyuanxingming = true;
          ...
          if(o=='chepiaoshoujia'){
            this.ruleForm.chepiaoshoujia = obj[o];
	    this.ro.chepiaoshoujia = true;
            continue;
          }
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.guanliyuangonghaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    // 下二随
    guanliyuangonghaoChange () {
      this.$http({
        url: `follow/yuangong/gonghao?columnValue=`+ this.ruleForm.guanliyuangonghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.guanliyuanxingming){
                this.ruleForm.guanliyuanxingming = data.data.guanliyuanxingming
              }
        } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhanwuguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhanwuguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
