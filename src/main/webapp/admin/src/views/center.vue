  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yuangong'"  label="经度" prop="longitude">
          <el-input v-model="ruleForm.longitude"               placeholder="经度" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yuangong'"  label="纬度" prop="latitude">
          <el-input v-model="ruleForm.latitude"               placeholder="纬度" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yuangong'"  label="地址" prop="fulladdress">
          <el-input v-model="ruleForm.fulladdress"               placeholder="地址" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'yuangong' ==this.flag && this.ruleForm.longitude&&(!isNumber(this.ruleForm.longitude))){
        this.$message.error(`经度应输入数字`);
        return
      }
      if( 'yuangong' ==this.flag && this.ruleForm.latitude&&(!isNumber(this.ruleForm.latitude))){
